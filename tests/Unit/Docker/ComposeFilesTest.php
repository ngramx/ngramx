...
class ComposeFilesTest extends TestCase
{
    ...
    public function test_all_input_files_includes_base_and_layered_overrides(): void
    {
        $compose = $this->tempDir . '/docker-compose.yml';
        $override = $this->tempDir . '/' . ComposeFiles::OVERRIDE_FILE;
        $user = $this->tempDir . '/' . ComposeFiles::USER_FILE;
        ...
        $this->assertSame(
            [$compose, $override, $user],
            ComposeFiles::allInputFiles($compose)
        );
    }

    public function test_it_detects_generated_override_files(): void
    {
        $override = $this->tempDir . '/' . ComposeFiles::OVERRIDE_FILE;
        file_put_contents($override, "# Generated by Ngramx CLI\nservices: {}\n");

        $this->assertTrue(ComposeFiles::isGeneratedOverride($override));
    }
