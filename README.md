...
- **Reuses your already-built Docker image** (re-tags the main checkout's image for the worktree's Compose project) instead of rebuilding from scratch. `vendor/` and `node_modules/` are installed from the lockfile when the project starts.
