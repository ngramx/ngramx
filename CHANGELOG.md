...
* **init-github-actions:** default --php-version to 8.3 (was 8.2) ([399b598](https://github.com/gigabyte-software/cortex-cli/commit/399b59879febf40d8acb09e990263c56e757f8f9))
...
* **auto-merge:** gate on size:small + risk:low labels classified by agents ([2b5ecdf](https://github.com/gigabyte-software/cortex-cli/commit/2b5ecdf9aca83af8a7ed77bd8a73e5974bc679c1))

# [2.19.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.18.0...v2.19.0) (2026-05-10)


### Features

* **agents:** drop parent-ticket / sub-issue workflow from agent instructions ([28dbb8c](https://github.com/gigabyte-software/cortex-cli/commit/28dbb8c55948d93342dbb3a981b8e4c318d14bbb))

# [2.18.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.17.0...v2.18.0) (2026-05-10)


### Features

* **init-github-actions:** use GitHub native auto-merge in caller template ([3bc31fb](https://github.com/gigabyte-software/cortex-cli/commit/3bc31fb8fcd532cc3b0f835c4d1eefbd9d5e2dd0))

# [2.17.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.16.0...v2.17.0) (2026-05-10)


### Features

* instruct agents to pre-create the parent branch and target it from sub-issue PRs ([64b877f](https://github.com/gigabyte-software/cortex-cli/commit/64b877fee09c2beb55ec1e3af0093638bf112c7b))
...
* update AGENTS.md to include guidance for creating linear tickets ([181d4e3](https://github.com/gigabyte-software/cortex-cli/commit/181d4e3a53aaf1ee9fdf304d43dd675e016baba4))

# [2.13.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.12.1...v2.13.0) (2026-04-30)


### Bug Fixes

* **etc-hosts-hint:** skip raw IP hostnames (gethostbyname ambiguity) ([735e176](https://github.com/gigabyte-software/cortex-cli/commit/735e1765b61a3b329ccc851aeeb7a498e71bb8e7))


### Features

* **up:** suggest /etc/hosts line when app_url hostname does not resolve ([fa0241c](https://github.com/gigabyte-software/cortex-cli/commit/fa0241cf2abc9e2661f89ce757504e30185b954e))

## [2.12.1](https://github.com/gigabyte-software/cortex-cli/compare/v2.12.0...v2.12.1) (2026-04-30)


### Bug Fixes

* **down:** guard lock read when JSON is corrupt or unreadable ([d671c29](https://github.com/gigabyte-software/cortex-cli/commit/d671c298a35b42907b9ac6be223c53c65ba05e6c))

# [2.12.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.11.1...v2.12.0) (2026-04-22)


### Features

* detect crash-looping services during cortex up ([fce5e90](https://github.com/gigabyte-software/cortex-cli/commit/fce5e90c3ade3bb5df5d60269508c891df19c58d))
...
* added parallel processing for user defined commands ([97c99ec](https://github.com/gigabyte-software/cortex-cli/commit/97c99ec720d2dccdbbfe41887280a261b039a11e))

# [2.10.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.9.1...v2.10.0) (2026-04-18)


### Features

* log output on up and rebuild, adjust timeouts, update docs for review command ([27b3c78](https://github.com/gigabyte-software/cortex-cli/commit/27b3c78486282403da5ba13877d5347ee3ddae7b))

## [2.9.1](https://github.com/gigabyte-software/cortex-cli/compare/v2.9.0...v2.9.1) (2026-04-16)


### Bug Fixes

* completion file lookup matches partial ticket numbers and drops @ prefix ([930886e](https://github.com/gigabyte-software/cortex-cli/commit/930886e60be33d71e5543baefcf55f647cc504f6))

# [2.9.0](https://github.com/gigabyte-software/cortex-cli/compare/v2.8.0...v2.9.0) (2026-04-16)


### Features

* add --quick option to review command to use clear instead of fresh ([b38e4b5](https://github.com/gigabyte-software/cortex-cli/commit/b38e4b579fc1b9b2751544a8db4c6b2b30236e12))
...
* simplify README installation docs ([aba28d5](https://github.com/gigabyte-software/cortex-cli/commit/aba28d5956bfa2a532b4b295793375d72613b401))
