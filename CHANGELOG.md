...
## [2.48.1](https://github.com/ngramx/ngramx/compare/v2.48.0...v2.48.1) (2026-09-24)


### Bug Fixes

* install worktree dependencies from the lockfile ([5955657](https://github.com/ngramx/ngramx/commit/5955657be7401e6162b277525caaac55c3c2c26b))
...
* do not kill MySQL dump restore on a fixed timeout ([9c96a6c](https://github.com/ngramx/ngramx/commit/9c96a6c3d234749f5a3049d3b0ec76e8a170d09b))
* do not report 100% when MySQL restore stream closes early ([255b2c5](https://github.com/ngramx/ngramx/commit/255b2c539c46e0acf3d500715913f03588f7ba78))
...
* skip password rotation unless ROTATE_DATABASE_PASSWORD is on ([77cdef5](https://github.com/ngramx/ngramx/commit/77cdef526921ed7166e3a05598b52aecfdb49f73))
...
* **worktree:** make multi-endpoint worktrees actually reachable ([#14](https://github.com/ngramx/ngramx/issues/14)) ([b768905](https://github.com/ngramx/ngramx/commit/b768905bc731a75c1b0bbd04186f7c998c529079))
...
* **postmaclone:** nightly produce and shared hosted refresh ([308c369](https://github.com/ngramx/ngramx/commit/308c369be1032db47b3260b7abc829a35010b069))
...
* **codabyte:** rename `coder` to `codabyte login` ([3dfea97](https://github.com/ngramx/ngramx/commit/3dfea974e4c9f6d4e88d29ab88e98c1d5394b689))
...
* **worktree:** alias only the vhost that serves the app ([2a2525e](https://github.com/ngramx/ngramx/commit/2a2525e44e4bb59fc6b34266447f1b9fddaeb800))
...
* **docker:** detect stale images when the Dockerfile changes ([f50c0ce](https://github.com/ngramx/ngramx/commit/f50c0ced57f47f9620193911dce33594394fbf38))

# [2.37.0](https://github.com/ngramx/ngramx/compare/v2.36.0...v2.37.0) (2026-08-18)


### Features

* make status a repo-wide worktree overview and cleanup selectable ([259ef06](https://github.com/ngramx/ngramx/commit/259ef062c4fd30610d157d62c6fb0672e7350dde))
...
* **docker:** make WSL auto-start actually reach Docker Desktop ([da3ee30](https://github.com/ngramx/ngramx/commit/da3ee30539500285ab1176d5e87b2db95a328756))
* **docker:** stop WSL launcher tests depending on the host ([5fddad2](https://github.com/ngramx/ngramx/commit/5fddad2894999f332d77aef628d44a63632d1cf1))

## [2.35.1](https://github.com/ngramx/ngramx/compare/v2.35.0...v2.35.1) (2026-08-18)


### Bug Fixes

* let shell secrets be satisfied by the project .env file ([cc06cc2](https://github.com/ngramx/ngramx/commit/cc06cc2fcadd18c5266faf2c700be20a18b87cc8))
...
* make worktree runs retryable and let callers pin a branch ([9209c2f](https://github.com/ngramx/ngramx/commit/9209c2f56eb9f025e44ac627f232569760f935ae))

## [2.34.1](https://github.com/ngramx/ngramx/compare/v2.34.0...v2.34.1) (2026-08-16)


### Bug Fixes

* let worktree and review skip host port mapping ([6c4db55](https://github.com/ngramx/ngramx/commit/6c4db5557e7bd5d1c4c691591879a8064e4fddc4))
...
* avoid false stale Docker image warnings in worktrees ([353377b](https://github.com/ngramx/ngramx/commit/353377bb8cc5fd94df864c8675fd5bbed3786f03))
...
* detect stale Docker images and seed Flux auth for worktrees ([2a9a959](https://github.com/ngramx/ngramx/commit/2a9a959f19e3f2ebf1ec507805479c6890e00620))
